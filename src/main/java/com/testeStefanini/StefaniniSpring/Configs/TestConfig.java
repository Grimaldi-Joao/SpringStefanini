...
import com.testeStefanini.StefaniniSpring.Repository.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {// essa classe serve para popular o a nossa aplicação
    ...
    public void run(String... args) throws Exception {
        User u1 = new User(null, "Maria Brown", "maria@gmail.com", "988888888", "1234566666");
        User u2 = new User(null, "Alex Green", "alex@gmail.com", "977777777", "12345666666");
        ...
        p1.getCategories().add(cat2);// Associando p1 senhor dos aneis com a categoria livros
        p2.getCategories().add(cat1);
        p2.getCategories().add(cat3);
        //Associando p2 com as categorias cat1 e cat2
        p3.getCategories().add(cat3);
        p4.getCategories().add(cat3);
        p5.getCategories().add(cat2);

        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));//salvando agora com as suas respectivas associações
